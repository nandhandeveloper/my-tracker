...
export class StoryDto {
  ...
  @ApiProperty({
    type: ProjectDto,
    description: 'story related to this project',
  })
  project: ProjectDto;
  @ApiProperty({
    type: String,
    enum: [StoryCritical.LOW, StoryCritical.MEDIUM, StoryCritical.HIGH],
    description: 'criticality of the story',
  })
  critical: StoryCritical;
  @ApiProperty({
    type: String,
    enum: [
      StoryTechnology.FRONTEND,
      StoryTechnology.BACKEND,
      StoryTechnology.DATABASE,
      StoryTechnology.DEVOPS,
      StoryTechnology.OTHER,
    ],
    description: 'which technology the story depends on',
  })
  ...
  @ApiProperty({
    ...
    description: 'The type of the story to work on',
  })
  type: StoryType;
  @ApiProperty({
    type: String,
    enum: [StoryStatus.ACTIVE, StoryStatus.INACTIVE, StoryStatus.COMPLETE],
